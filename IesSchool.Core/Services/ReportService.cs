...
namespace IesSchool.Core.Services
{
	internal class ReportService : IReportService
	{
		...
		//			.Include(x => x.Student).ThenInclude(x => x.Teacher)
		//			.Include(x => x.Therapist).Include(x => x.AcadmicYear).Include(x => x.Term)
		...
		//					therapistDepartmentName = itp.TherapistIdDepartmentId == null ? "" : itp.TherapistIdDepartmentId.de;
		//				}
						
		//				if (itp.HeadOfEducation != null)
		//				{
		//					itpHeadOfEducationName = iep.HeadOfEducationNavigation.Name == null ? "" : iep.HeadOfEducationNavigation.Name;
		//				}
		//				if (iep.Term != null)
		//				{
		//					termName = iep.Term.Name == null ? "" : iep.Term.Name;
