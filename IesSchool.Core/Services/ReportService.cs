...
namespace IesSchool.Core.Services
{
    internal class ReportService : IReportService
    {
            ...
            try
            {
                using (ExcelEngine excelEngine = new ExcelEngine())
                {
                    ...
                    if (iepProgressReportDto != null)
                    {
                        ...
                        worksheet.Range["A1:AH1"].Text = "Extra Curricula";
                        worksheet.Range["A1:AH1"].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A1:AH1"].CellStyle.Borders[ExcelBordersIndex.EdgeTop].LineStyle = ExcelLineStyle.Thin;
                        ...
                        if (iepProgressReportDto.ProgressReportExtraCurriculars.Count > 0)
                        {
                            foreach (var extra in iepProgressReportDto.ProgressReportExtraCurriculars)
                            {
                                ...
                                worksheet.Range["A" + (lastRow ) + ":Q" + (lastRow )].Text = extra.ExtraCurricularName == null ? "" : extra.ExtraCurricularName;
                                ...
                                worksheet.Range["R" + (lastRow ) + ":AH" + (lastRow )].Text = extra.ExtraCurricularNameAr == null ? "" : extra.ExtraCurricularNameAr;

                                worksheet.Range["A" + (lastRow + 1) + ":AH" + (lastRow + 6)].Merge();
                                worksheet.Range["A" + (lastRow + 1) + ":AH" + (lastRow + 6)].Text = extra.Comment == null ? "" : extra.Comment;
                                worksheet.Range["A" + (lastRow + 6) + ":Ah" + (lastRow + 6)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                        ...
                        if ( iepProgressReportDto.ProgressReportExtraCurriculars.Count < 5)
                        {
                            ...
                            {
                                worksheet.Range["A" + (lastRow) + ":Q" + (lastRow)].Merge();
                                worksheet.Range["A" + (lastRow) + ":Q" + (lastRow)].Text = "";
                                worksheet.Range["Q" + (lastRow)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["A" + (lastRow) + ":Ah" + (lastRow)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                                ...
                                worksheet.Range["A" + (lastRow) + ":Ah" + (lastRow)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                                worksheet.Range["R" + (lastRow) + ":AH" + (lastRow)].Merge();
                                worksheet.Range["R" + (lastRow) + ":AH" + (lastRow)].Text = "";

                                worksheet.Range["A" + (lastRow + 1) + ":AH" + (lastRow + 6)].Merge();
                                worksheet.Range["A" + (lastRow + 1) + ":AH" + (lastRow + 6)].Text = "";
                                worksheet.Range["A" + (lastRow + 6) + ":Ah" + (lastRow + 6)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["AH" + (lastRow) + ":Ah" + (lastRow + 6)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        ...
                        lastRow = worksheet.Rows.Length + 2;
                        worksheet.Range["A" + (lastRow) + ":AH" + (lastRow)].Merge();
                        worksheet.Range["A" + (lastRow) + ":AH" + (lastRow)].Text = "Educational";
                        worksheet.Range["A" + (lastRow) + ":AH" + (lastRow)].CellStyle.Color = Color.FromArgb(255, 255, 200);
                        worksheet.Range["A" + (lastRow) + ":AH" + (lastRow)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A" + (lastRow) + ":AH" + (lastRow)].CellStyle.Borders[ExcelBordersIndex.EdgeTop].LineStyle = ExcelLineStyle.Thin;
                        ...
                        if (iepProgressReportDto.ProgressReportStrands.Count > 0)
                        {
                            foreach (var strand in iepProgressReportDto.ProgressReportStrands.ToList())
                            {
                                ...
                                worksheet.Range["A" + (lastRow + 1) + ":AH" + (lastRow + 5)].CellStyle.Borders[ExcelBordersIndex.EdgeTop].LineStyle = ExcelLineStyle.Thin;

                                worksheet.Range["A" + (lastRow + 1) + ":Q" + (lastRow + 1)].Merge();
                                worksheet.Range["A" + (lastRow + 1) + ":Q" + (lastRow + 1)].Text = strand.AreaName == null ? "" : strand.AreaName;
                                ...
                                worksheet.Range["R" + (lastRow + 1) + ":AH" + (lastRow + 1)].Text = strand.StrandName == null ? "" : strand.StrandName;

                                worksheet.Range["A" + (lastRow + 2) + ":AH" + (lastRow + 2)].Merge();
                                worksheet.Range["A" + (lastRow + 2) + ":AH" + (lastRow + 2)].Text = "Comment:";

                                worksheet.Range["A" + (lastRow + 3) + ":AH" + (lastRow + 7)].Merge();
                                worksheet.Range["A" + (lastRow + 3) + ":AH" + (lastRow + 7)].Text = strand.Comment == null ? "" : strand.Comment;
                                worksheet.Range["AH" + (lastRow + 1) + ":AH" + (lastRow + 7)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        ...
                        if( iepProgressReportDto.ProgressReportStrands.Count < 5)
                        {
                            ...
                            for (int i = 0; i < count; i++)
                            {
                                ...
                                worksheet.Range["A" + (lastRow + 1) + ":Q" + (lastRow + 1)].Merge();
                                worksheet.Range["A" + (lastRow + 1) + ":Q" + (lastRow + 1)].Text = "";
                                worksheet.Range["Q" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;

                                worksheet.Range["A" + (lastRow + 1) + ":Ah" + (lastRow + 1)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                                worksheet.Range["R" + (lastRow + 1) + ":AH" + (lastRow + 1)].Merge();
                                worksheet.Range["R" + (lastRow + 1) + ":AH" + (lastRow + 1)].Text = "";

                                worksheet.Range["A" + (lastRow + 2) + ":AH" + (lastRow + 2)].Merge();
                                worksheet.Range["A" + (lastRow + 2) + ":AH" + (lastRow + 2)].Text = "Comment:";

                                worksheet.Range["A" + (lastRow + 3) + ":AH" + (lastRow + 7)].Merge();
                                worksheet.Range["A" + (lastRow + 3) + ":AH" + (lastRow + 7)].Text = "";
                                worksheet.Range["AH" + (lastRow + 1) + ":AH" + (lastRow + 7)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        ...
                        worksheet.Range["A" + (lastRow) + ":A" + (lastRow + 4)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                        ...
                        worksheet.Range["AO" + (lastRow) + ":BS" + (lastRow)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["AO" + (lastRow) + ":BS" + (lastRow)].CellStyle.Borders[ExcelBordersIndex.EdgeTop].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["AO" + (lastRow) + ":BS" + (lastRow)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["AO" + (lastRow) + ":BS" + (lastRow)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                        ...
                        if (iepProgressReportDto.ProgressReportParamedicals.Count > 0)
                        {
                            ...
                            {
                                worksheet.Range["AO" + (lastRow + 1) + ":BC" + (lastRow + 1)].Merge();
                                worksheet.Range["AO" + (lastRow + 1) + ":BC" + (lastRow + 1)].Text = para.ParamedicalServiceName == null ? "" : para.ParamedicalServiceName;
                                worksheet.Range["BC" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["AO" + (lastRow + 1) + ":BS" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["AO" + (lastRow + 1) + ":BS" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;


                                worksheet.Range["AO" + (lastRow + 1) + ":BS" + (lastRow + 1)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                                worksheet.Range["BD" + (lastRow + 1) + ":BS" + (lastRow + 1)].Merge();
                                worksheet.Range["BD" + (lastRow + 1) + ":BS" + (lastRow + 1)].Text = para.ParamedicalServiceNameAr == null ? "" : para.ParamedicalServiceNameAr;

                                worksheet.Range["AO" + (lastRow + 2) + ":BS" + (lastRow + 5)].Merge();
                                worksheet.Range["AO" + (lastRow + 2) + ":BS" + (lastRow + 5)].Text = para.Comment == null ? "" : para.Comment;
                                worksheet.Range["AO" + (lastRow + 5) + ":BS" + (lastRow + 5)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["BS" + (lastRow + 1) + ":BS" + (lastRow + 5)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["AO" + (lastRow + 1) + ":BS" + (lastRow + 5)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                        ...
                        if ( iepProgressReportDto.ProgressReportParamedicals.Count < 3)
                        {
                            ...
                            {
                                worksheet.Range["AO" + (lastRow + 1) + ":BC" + (lastRow + 1)].Merge();
                                worksheet.Range["AO" + (lastRow + 1) + ":BC" + (lastRow + 1)].Text = "";
                                worksheet.Range["BC" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["AO" + (lastRow + 1) + ":BS" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["AO" + (lastRow + 1) + ":BS" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                                ...
                                worksheet.Range["AO" + (lastRow + 1) + ":BS" + (lastRow + 1)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                                worksheet.Range["BD" + (lastRow + 1) + ":BS" + (lastRow + 1)].Merge();
                                worksheet.Range["BD" + (lastRow + 1) + ":BS" + (lastRow + 1)].Text = "";

                                worksheet.Range["AO" + (lastRow + 2) + ":BS" + (lastRow + 5)].Merge();
                                worksheet.Range["AO" + (lastRow + 2) + ":BS" + (lastRow + 5)].Text = "";
                                worksheet.Range["AO" + (lastRow + 5) + ":BS" + (lastRow + 5)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["BS" + (lastRow + 1) + ":BS" + (lastRow + 5)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["AO" + (lastRow + 1) + ":BS" + (lastRow + 5)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                        ...
                        if (iepProgressReportDto.ProgressReportStrands.Count() > 0)
                        {
                            ...
                            chart.TopRow = lastRow + 2;
                            chart.LeftColumn = 41;
                            chart.RightColumn = 71;
                            chart.BottomRow = lastRow + 27;
        ...
        public string ItpProgressReportHTML(int itpProgressReportId)
        {
            try
            {
                using (ExcelEngine excelEngine = new ExcelEngine())
                {
                    ...
                    worksheet.Range["A1:BF" + (lastRow)].CellStyle.HorizontalAlignment = ExcelHAlign.HAlignCenter;
                    worksheet.Range["A1:BF" + (lastRow)].CellStyle.VerticalAlignment = ExcelVAlign.VAlignCenter;
                    worksheet.Range["A1:BF" + (lastRow)].CellStyle.Font.Size = 11;
                ...
                using (ExcelEngine excelEngine = new ExcelEngine())
                {
                    ...
                    if (iepProgressReportDto != null)
                    {
                        ...
                        if (iepProgressReportDto.ProgressReportParamedicals.Count > 0)
                        {
                            ...
                            worksheet.Range["AH1:AH" + (lastRow)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
        ...
        public string IepReportHTML(int ieptId)
        {
            try
            {
                using (ExcelEngine excelEngine = new ExcelEngine())
                {
                    ...
                    var iep = _uow.GetRepository<Iep>().Single(x => x.Id == ieptId && x.IsDeleted != true, null, x => x.Include(x => x.Student).ThenInclude(x => x.Department)
                    .Include(x => x.Student).ThenInclude(x => x.Teacher)
                    .Include(x => x.Teacher).Include(x => x.AcadmicYear).Include(x => x.Term)
                    .Include(x => x.HeadOfDepartmentNavigation)
                    .Include(x => x.HeadOfEducationNavigation)
                    ...
                    if (iep != null)
                    {
                        ...
                        #endregion
                        //var iepGoals = iep.Goals.Where(x => x.IsDeleted != true).ToList();
                        var iepGoals = _uow.GetRepository<Goal>().GetList(x => x.Iepid == ieptId && x.IsDeleted != true, null, x => x.Include(x => x.Strand).Include(x => x.Area).Include(x => x.Objectives).ThenInclude(x => x.ObjectiveSkills).ThenInclude(x => x.Skill).Include(x => x.Objectives).ThenInclude(x => x.ObjectiveEvaluationProcesses).ThenInclude(x => x.SkillEvaluation));
                        var mapperGoals = _mapper.Map<Paginate<GoalDto>>(iepGoals).Items;
            ...
            try
            {
                using (ExcelEngine excelEngine = new ExcelEngine())
                {
                    ...
                    if (AllIepObjectives != null && AllIepObjectives.Items.Count() > 0)
                    {
                        ...
                        foreach (var objective in AllIepObjectives.Items)
                        {
                            ...
                            if (objective.Activities.Count() > 0)
                            {
                                ...
                                foreach (var item in listOfObjActivities)
                                {
                                    worksheet.Range["A" + row + ":A" + row].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                    ...
                    else
                    {
                        ...
                        worksheet.PageSetup.Orientation = ExcelPageOrientation.Landscape;
                        worksheet.Range["A1:A4"].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A6"].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A1:BE1"].CellStyle.Borders[ExcelBordersIndex.EdgeTop].LineStyle = ExcelLineStyle.Thin;
                    ...
                    {
                        var fileName = Guid.NewGuid().ToString().Replace("-", "");
                        var filePath = Path.Combine(target, fileName + ".pdf");
                        using (var stream1 = new FileStream(filePath, FileMode.Create))
                        {
                            pdfDoc.Save(stream1);
                        }
            ...
            try
            {
                using (ExcelEngine excelEngine = new ExcelEngine())
                {
                    ...
                    if (iep != null)
                    {
                        ...
                        #endregion
                        #region IEP
                        worksheet.Range["A1:A9"].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A1:BE9"].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["BE1:BE9"].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["AH2:AH4"].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["AL2:AL4"].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        ...
                        if (mapperGoals != null && mapperGoals.Count() > 0)
                        {
                            foreach (var goal in mapperGoals)
                            {
                                #region Goals
                                worksheet.Range["A" + (lastRow + 1) + ":BE" + (lastRow + 11)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["A" + (lastRow + 2) + ":A" + (lastRow + 11)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["BE" + (lastRow + 2) + ":BE" + (lastRow + 11)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["A" + (lastRow + 2) + ":K" + (lastRow + 2)].Merge();
                                worksheet.Range["A" + (lastRow + 2) + ":K" + (lastRow + 2)].Text = "Goal Area:";
                                worksheet.Range["A" + (lastRow + 2) + ":K" + (lastRow + 2)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                                ...
                                if (goal.Objectives != null && goal.Objectives.Count() > 0)
                                {
                                    ...
                                    if (goalObjectives.Count() > 0)
                                    {
                                        ...
                                        foreach (var objective in goalObjectives)
                                        {
                                            ...
                                            worksheet.Range["A" + (lastRow + 1) + ":A" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                                ...
                                else
                                {
                                    ...
                                    worksheet.Range["A" + (lastRow + 12) + ":BE" + (lastRow + 14)].Text = " No Objects Found";
                                    worksheet.Range["A" + (lastRow + 12) + ":BE" + (lastRow + 14)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                                    worksheet.Range["A" + (lastRow + 12) + ":A" + (lastRow + 14)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                                    worksheet.Range["A" + (lastRow + 12) + ":BE" + (lastRow + 14)].CellStyle.Borders[ExcelBordersIndex.EdgeTop].LineStyle = ExcelLineStyle.Thin;
                                    worksheet.Range["A" + (lastRow + 12) + ":BE" + (lastRow + 14)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                                    lastRow = worksheet.Rows.Length;
                                }
                        ...
                        else
                        {
                            ...
                            worksheet.Range["A" + (lastRow + 2) + ":BE" + (lastRow + 4)].Merge();
                            worksheet.Range["A" + (lastRow + 2) + ":BE" + (lastRow + 4)].Text = " No Goals Found";
                            worksheet.Range["A" + (lastRow + 2) + ":A" + (lastRow + 4)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                            worksheet.Range["A" + (lastRow + 2) + ":BE" + (lastRow + 4)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                            worksheet.Range["A" + (lastRow + 2) + ":BE" + (lastRow + 4)].CellStyle.Borders[ExcelBordersIndex.EdgeTop].LineStyle = ExcelLineStyle.Thin;
                            worksheet.Range["A" + (lastRow + 2) + ":BE" + (lastRow + 4)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                            lastRow = worksheet.Rows.Length;
                        ...
                        worksheet.Range["A" + (lastRow + 2) + ":BE" + (lastRow + 2)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A" + (lastRow + 2) + ":BE" + (lastRow + 2)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A" + (lastRow + 2) + ":A" + (lastRow + 3)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A" + (lastRow + 2) + ":BE" + (lastRow + 2)].CellStyle.Color = Color.FromArgb(255, 255, 200);
                        worksheet.Range["A" + (lastRow + 2) + ":BE" + (lastRow + 2)].Merge();
                        worksheet.Range["A" + (lastRow + 2) + ":BE" + (lastRow + 2)].Text = "Student Involved in Para-Medical Services/Support";
                        ...
                        if (iep.IepParamedicalServices != null && iep.IepParamedicalServices.Count() > 0)
                        {
                            foreach (var Para in iep.IepParamedicalServices)
                            {
                                ...
                                worksheet.Range["A" + (lastRow + 1) + ":BE" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["A" + (lastRow + 1) + ":AD" + (lastRow + 1)].Merge();
                                worksheet.Range["A" + (lastRow + 1) + ":AD" + (lastRow + 1)].Text = Para.ParamedicalService == null ? "" : Para.ParamedicalService.Name;
                                worksheet.Range["A" + (lastRow + 1) + ":AD" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;

                                worksheet.Range["AE" + (lastRow + 1) + ":BE" + (lastRow + 1)].Merge();
                                worksheet.Range["AE" + (lastRow + 1) + ":BE" + (lastRow + 1)].Text = "Yes";
                                worksheet.Range["AE" + (lastRow + 1) + ":BE" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                                lastRow++;
                            }
                        ...
                        else
                        {
                            ...
                            worksheet.Range["A" + (lastRow + 1) + ":BE" + (lastRow + 2)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                            worksheet.Range["A" + (lastRow + 1) + ":BE" + (lastRow + 2)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                            worksheet.Range["A" + (lastRow + 1) + ":A" + (lastRow + 2)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                            lastRow = lastRow + 3;
                        }
                        ...
                        worksheet.Range["A" + lastRow + ":A" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A" + lastRow + ":BE" + lastRow].CellStyle.Borders[ExcelBordersIndex.EdgeTop].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A" + lastRow + ":BE" + lastRow].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A" + lastRow + ":BE" + lastRow].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A" + lastRow + ":BE" + lastRow].CellStyle.Color = Color.FromArgb(255, 255, 200);
                        ...
                        if (iep.IepExtraCurriculars != null && iep.IepExtraCurriculars.Count() > 0)
                        {
                            ...
                            foreach (var extra in iep.IepExtraCurriculars)
                            {
                                ...
                                worksheet.Range["AE" + (lastRow + 2) + ":BE" + (lastRow + 2)].Text = "Yes";
                                worksheet.Range["AE" + (lastRow + 2) + ":BE" + (lastRow + 2)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                                worksheet.Range["A" + (lastRow + 2) + ":A" + (lastRow + 2)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                                lastRow++;
                            }
                        }
                        else
                        ...
                        worksheet.Range["A" + (lastRow + 1) + ":BE" + (lastRow + 7)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A" + (lastRow + 2) + ":A" + (lastRow + 4)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A" + (lastRow + 6) + ":A" + (lastRow + 7)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
        ...
        public ResponseDto IepProgressReportPdfPreview(int iepProgressReportId)
        {
            try
            {
                using (ExcelEngine excelEngine = new ExcelEngine())
                {
                    ...
                    pdfDoc = renderer.ConvertToPDF(worksheet, settings);
            ...
            try
            {
                using (ExcelEngine excelEngine = new ExcelEngine())
                {
                    ...
                    if (itp != null)
                    {
                        ...
                        #endregion
                        #region ITP
                        worksheet.Range["A1:A12"].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                        ...
                        if (itp.ItpGoals.Count() > 0)
                        {
                            ...
                            foreach (var goal in itp.ItpGoals)
                            {
                                ...
                                if (goal.ItpGoalObjectives != null && goal.ItpGoalObjectives.Count() > 0)
                                {
                                    ...
                                    if (goalObjectives.Count() > 0)
                                    {
                                        ...
                                        foreach (var objective in goalObjectives)
                                        {
                                            ...
                                            worksheet.Range["A" + (lastRow + 1) + ":A" + (lastRow + 5)].CellStyle.Color = Color.FromArgb(255, 255, 200);
                                            worksheet.Range["A" + (lastRow + 1) + ":A" + (lastRow + 5)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                                            worksheet.Range["A" + (lastRow + 1) + ":A" + (lastRow + 5)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                                ...
                                else
                                {
                                    ...
                                    worksheet.Range["A" + (lastRow + 1) + ":BE" + (lastRow + 3)].CellStyle.Borders[ExcelBordersIndex.EdgeTop].LineStyle = ExcelLineStyle.Thin;
                                    worksheet.Range["A" + (lastRow + 1) + ":BE" + (lastRow + 3)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                                    worksheet.Range["A" + (lastRow + 1) + ":A" + (lastRow + 3)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                                    lastRow = worksheet.Rows.Length + 3;
                                }
            ...
            try
            {
                using (ExcelEngine excelEngine = new ExcelEngine())
                {
                    ...
                    if (itpProgressReport != null)
                    {
                        ...
                        lastRow = worksheet.Rows.Length;
                        worksheet.Range["A" + (lastRow + 1) + ":A" + (lastRow + 13)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
            ...
            try
            {
                using (ExcelEngine excelEngine = new ExcelEngine())
                {
                    ...
                    if (ixp != null)
                    {
                        ...
                        worksheet.Range["A" + (lastRow + 1) + ":W" + (lastRow + 1)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                        worksheet.Range["W" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["A" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
                        ...
                        if (ixp.IxpExtraCurriculars.Count() > 0)
                        {
                            ...
                            worksheet.Range["AN" + (lastRow) + ":BE" + (lastRow)].Text = "";
                            worksheet.Range["BE" + (lastRow)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                            worksheet.Range["A" + (lastRow)].CellStyle.Borders[ExcelBordersIndex.EdgeLeft].LineStyle = ExcelLineStyle.Thin;
        ...
        public FileStreamResult StudentReport(StudentSearchDto studentSearchDto)
        {
            try
            {
                using (ExcelEngine excelEngine = new ExcelEngine())
                {
                    ...
                    var allStudents = _uow.GetRepository<Student>().GetList(x => x.IsDeleted != true, x => x.OrderBy(c => c.Code), x=> x.Include(x=> x.Nationality), 0, 100000, true).Items;
                    ...
                    {
                        allStudents = allStudents.Where(x => x.NationalityId == studentSearchDto.NationalityId).ToList();
                    }
                    if (studentSearchDto.DepartmentId != null)
                    {
                        allStudents = allStudents.Where(x => x.DepartmentId == studentSearchDto.DepartmentId).ToList();
                    }
                    ...
                    {
                        allStudents = allStudents.Where(x => x.CityId == studentSearchDto.CityId).ToList();
                    }
                    if (studentSearchDto.IsSuspended != null)
                    {
                        allStudents = allStudents.Where(x => x.IsSuspended == studentSearchDto.IsSuspended).ToList();
                    }
                    if (studentSearchDto.IsActive != null)
                    {
                        allStudents = allStudents.Where(x => x.IsActive == studentSearchDto.IsActive).ToList();
                    }

                    IWorkbook workbook = application.Workbooks.Create(0);
                    IWorksheet worksheet;

                    worksheet = workbook.Worksheets.Create("Students");
                    worksheet.PageSetup.Orientation = ExcelPageOrientation.Landscape;
                    #region General
                    worksheet.IsGridLinesVisible = true;
                    worksheet.Range["A1:BE1"].ColumnWidth = 1;
                    ...
                    {
                        #region Teacher Info
                        worksheet.Range["A1:BE3"].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["BE1:BE3"].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["AH2:AH3"].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["AL2:AL3"].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["J2:J3"].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["R3"].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["AS2"].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["AW2"].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["R3"].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["AV2"].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        worksheet.Range["AZ2"].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;



                        worksheet.Range["A1:BE1"].Merge();
                        worksheet.Range["A1:BE1"].Text = "IDEAL EDUCATION SCHOOL";
                        worksheet.Range["A1:BE1"].CellStyle.Color = Color.FromArgb(255, 255, 200);

                        worksheet.Range["A2:J2"].Merge();
                        worksheet.Range["A2:J2"].Text = "TEACHER:";
                        worksheet.Range["A2:J2"].CellStyle.Color = Color.FromArgb(255, 205, 205);

                        worksheet.Range["K2:AH2"].Merge();
                        worksheet.Range["K2:AH2"].Text = teacher.Name ?? "";
                        worksheet.Range["AI2:AL2"].Merge();
                        worksheet.Range["AI2:AL2"].Text = "DEPT:";
                        worksheet.Range["AI2:AL2"].CellStyle.Color = Color.FromArgb(255, 205, 205);

                        worksheet.Range["AM2:AV2"].Merge();
                        worksheet.Range["AM2:AV2"].Text = teacher.Department == null ? "" : teacher.Department.Name;
                        worksheet.Range["AW2:AZ2"].Merge();
                        worksheet.Range["AW2:AZ2"].Text = "RM#:";
                        worksheet.Range["AW2:AZ2"].CellStyle.Color = Color.FromArgb(255, 205, 205);

                        worksheet.Range["BA2:BE2"].Merge();
                        worksheet.Range["BA2:BE2"].Text = teacher.RoomNumber.ToString() ?? "";

                        worksheet.Range["A3:J3"].Merge();
                        worksheet.Range["A3:J3"].Text = "ASSISTANTS:";
                        worksheet.Range["A3:J3"].CellStyle.Color = Color.FromArgb(255, 205, 205);


                        worksheet.Range["K3:BE3"].Merge();
                        if (teacher.UserAssistants.Count() > 0)
                        {
                            var teacherAss = teacher.UserAssistants.ToList().Select(x => (x.Assistant == null ? "" : x.Assistant.Name)).ToArray();
                            worksheet.Range["K3:BE3"].Text = string.Join(",", teacherAss);
                        }
                        #endregion
                        #region Students
                        if (allStudents.Count() > 0)
                        {
                            ...
                            worksheet.Range["A" + (lastRow + 1) + ":B" + (lastRow + 1)].Text = "SN";
                            worksheet.Range["A" + (lastRow + 1) + ":B" + (lastRow + 1)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                            worksheet.Range["B" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;

                            worksheet.Range["C" + (lastRow + 1) + ":G" + (lastRow + 1)].Merge();
                            worksheet.Range["C" + (lastRow + 1) + ":G" + (lastRow + 1)].Text = "Number";
                            worksheet.Range["C" + (lastRow + 1) + ":G" + (lastRow + 1)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                            worksheet.Range["G" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;


                            worksheet.Range["H" + (lastRow + 1) + ":AM" + (lastRow + 1)].Merge();
                            worksheet.Range["H" + (lastRow + 1) + ":AM" + (lastRow + 1)].Text = "Name";
                            worksheet.Range["H" + (lastRow + 1) + ":AM" + (lastRow + 1)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                            worksheet.Range["AM" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;

                            worksheet.Range["AN" + (lastRow + 1) + ":AV" + (lastRow + 1)].Merge();
                            worksheet.Range["AN" + (lastRow + 1) + ":AV" + (lastRow + 1)].Text = "DOB";
                            worksheet.Range["AN" + (lastRow + 1) + ":AV" + (lastRow + 1)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                            worksheet.Range["AV" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;

                            worksheet.Range["AW" + (lastRow + 1) + ":BE" + (lastRow + 1)].Merge();
                            worksheet.Range["AW" + (lastRow + 1) + ":BE" + (lastRow + 1)].Text = "Ministry#";
                            worksheet.Range["AW" + (lastRow + 1) + ":BE" + (lastRow + 1)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                            worksheet.Range["BE" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                            ...
                            foreach (var item in allStudents)
                            {
                               ...
                               // worksheet.Range["A" + (lastRow + 1) + ":B" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                                ...
                                worksheet.Range["C" + (lastRow + 1) + ":G" + (lastRow + 1)].Merge();
                                worksheet.Range["C" + (lastRow + 1) + ":G" + (lastRow + 1)].Text = item.Code == null ? "" : item.Code.ToString();
                                worksheet.Range["G" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;


                                worksheet.Range["H" + (lastRow + 1) + ":AM" + (lastRow + 1)].Merge();
                                worksheet.Range["H" + (lastRow + 1) + ":AM" + (lastRow + 1)].Text = item.Name == null ? "" : item.Name;
                                worksheet.Range["AM" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;

                                worksheet.Range["AN" + (lastRow + 1) + ":AV" + (lastRow + 1)].Merge();
                                worksheet.Range["AN" + (lastRow + 1) + ":AV" + (lastRow + 1)].Text = item.DateOfBirth == null ? "" : item.DateOfBirth.Value.ToShortDateString();
                                worksheet.Range["AV" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;

                                worksheet.Range["AW" + (lastRow + 1) + ":BE" + (lastRow + 1)].Merge();
                                worksheet.Range["AW" + (lastRow + 1) + ":BE" + (lastRow + 1)].Text = item.MinistryNumber == null ? "" : item.MinistryNumber.ToString();
                                worksheet.Range["BE" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                                stdCount++;
                            }
                            worksheet.Range["A" + (lastRow + 1) + ":BE" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                        ...
                        else
                        {
                            lastRow = worksheet.Rows.Length + 1;
                            worksheet.Range["A" + (lastRow + 1) + ":BE" + (lastRow + 3)].Merge();
                            worksheet.Range["A" + (lastRow + 1) + ":BE" + (lastRow + 3)].Text = "No Students Found";
                            worksheet.Range["A" + (lastRow + 1) + ":BE" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeTop].LineStyle = ExcelLineStyle.Thin;
                            worksheet.Range["A" + (lastRow + 3) + ":BE" + (lastRow + 3)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                            worksheet.Range["BE" + (lastRow + 1) + ":BE" + (lastRow + 3)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                    ...
                    else
                    {
                        ...
                        worksheet.Range["BE1"].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                        ...
                        if (allStudents.Count() > 0)
                        {
                            ...
                            worksheet.Range["H" + (lastRow + 1) + ":AF" + (lastRow + 1)].Merge();
                            worksheet.Range["H" + (lastRow + 1) + ":AF" + (lastRow + 1)].Text = "Name";
                            worksheet.Range["H" + (lastRow + 1) + ":AF" + (lastRow + 1)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                            worksheet.Range["AF" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;

                            worksheet.Range["AG" + (lastRow + 1) + ":AM" + (lastRow + 1)].Merge();
                            worksheet.Range["AG" + (lastRow + 1) + ":AM" + (lastRow + 1)].Text = "DOB";
                            worksheet.Range["AG" + (lastRow + 1) + ":AM" + (lastRow + 1)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                            worksheet.Range["AM" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;

                            worksheet.Range["AN" + (lastRow + 1) + ":AS" + (lastRow + 1)].Merge();
                            worksheet.Range["AN" + (lastRow + 1) + ":AS" + (lastRow + 1)].Text = "Ministry#";
                            worksheet.Range["AN" + (lastRow + 1) + ":AS" + (lastRow + 1)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                            worksheet.Range["AS" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;

                            worksheet.Range["AT" + (lastRow + 1) + ":BE" + (lastRow + 1)].Merge();
                            worksheet.Range["AT" + (lastRow + 1) + ":BE" + (lastRow + 1)].Text = "Nationality";
                            worksheet.Range["AT" + (lastRow + 1) + ":BE" + (lastRow + 1)].CellStyle.Color = Color.FromArgb(255, 205, 205);
                            worksheet.Range["BE" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                            ...
                            foreach (var item in allStudents)
                            {
                               ...
                               // worksheet.Range["A" + (lastRow + 1) + ":B" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeBottom].LineStyle = ExcelLineStyle.Thin;
                                ...
                                worksheet.Range["H" + (lastRow + 1) + ":AF" + (lastRow + 1)].Merge();
                                worksheet.Range["H" + (lastRow + 1) + ":AF" + (lastRow + 1)].Text = item.Name == null ? "" : item.Name;
                                worksheet.Range["AF" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;

                                worksheet.Range["AG" + (lastRow + 1) + ":AM" + (lastRow + 1)].Merge();
                                worksheet.Range["AG" + (lastRow + 1) + ":AM" + (lastRow + 1)].Text = item.DateOfBirth == null ? "" : item.DateOfBirth.Value.ToShortDateString();
                                worksheet.Range["AM" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;

                                worksheet.Range["AN" + (lastRow + 1) + ":AS" + (lastRow + 1)].Merge();
                                worksheet.Range["AN" + (lastRow + 1) + ":AS" + (lastRow + 1)].Text = item.MinistryNumber == null ? "" : item.MinistryNumber.ToString();
                                worksheet.Range["AS" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;


                                worksheet.Range["AT" + (lastRow + 1) + ":BE" + (lastRow + 1)].Merge();
                                worksheet.Range["AT" + (lastRow + 1) + ":BE" + (lastRow + 1)].Text = item.Nationality==null?"": item.Nationality.Name;
                                worksheet.Range["BE" + (lastRow + 1)].CellStyle.Borders[ExcelBordersIndex.EdgeRight].LineStyle = ExcelLineStyle.Thin;
                    ...
                    fileStreamResult.FileDownloadName = ("StudentReport" + ".xlsx");
        ...
        public FileStreamResult TeacherStudentsReport(int teacherId)
        {
            try
            {
                using (ExcelEngine excelEngine = new ExcelEngine())
                {
                    ...
                    int lastRow = 0;
                    User teacher = new User();
                    var allStudents = _uow.GetRepository<Student>().GetList(x => x.IsDeleted != true && x.TeacherId==teacherId, x => x.OrderBy(c => c.Code), x => x.Include(x => x.Nationality), 0, 100000, true).Items;
                    teacher = _uow.GetRepository<User>().Single(x => x.Id == teacherId, null, x => x.Include(x => x.Department).Include(x => x.UserAssistants).ThenInclude(x => x.Assistant));
                    ...
                    fileStreamResult.FileDownloadName = ("TeacherStudentsReport" + ".xlsx");
