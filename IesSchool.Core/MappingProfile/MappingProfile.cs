        ...
        public AutoMapperProfile()
        {
         ...
         .ForMember(x => x.Student, op => op.Ignore());
           ...
           .ForAllMembers(opts => opts.Condition((src, dest, srcMember) => srcMember != null));
            ...
            CreateMap<IepHelper2, IepHelper2Dto>().ReverseMap();
            ...
            CreateMap<IepExtraCurricular, IepExtraTeacherDto>()
           .ForMember(dist => dist.ExtraCurricularName, opt => opt.MapFrom(c => c.ExtraCurricular == null ? "" : c.ExtraCurricular.Name))
          ...
          .ReverseMap()
           ...
           .ForMember(x => x.ExTeacher, op => op.Ignore());
            ...
            .ForMember(dist => dist.StudentBirthDay, opt => opt.MapFrom(c => c.Student == null ? "" : c.Student.DateOfBirth.Value.ToShortDateString()))
           ...
           .ForMember(dist => dist.ExtraCurricularNameAr, opt => opt.MapFrom(c => c.ExtraCurricular == null ? "" : c.ExtraCurricular.NameAr))
               .ReverseMap()
            .ForMember(x => x.ExtraCurricular, op => op.Ignore())
            .ForMember(x => x.ProgressReport, op => op.Ignore())
            ...
            .ForMember(dist => dist.TermName, opt => opt.MapFrom(c => c.ProgressReport == null ? "" : c.ProgressReport.Term == null ? "" : c.ProgressReport.Term.Name))
             ...
             .ForMember(x => x.ParamedicalService, op => op.Ignore())
             .ForMember(x => x.ProgressReport, op => op.Ignore())
             .ForMember(x => x.IepParamedicalSercive, op => op.Ignore());
          ...
          .ForMember(x => x.EventType, op => op.Ignore());
           ...
           .ForMember(x => x.ParamedicalService, op => op.Ignore());
            ...
            CreateMap<IepParamedicalService, IepParamedicalCreateItpDto>()
          .ForMember(dist => dist.IepStudentId, opt => opt.MapFrom(c => c.Iep == null ? 0 : c.Iep.Student == null ? 0 : c.Iep.Student.Id))
          .ForMember(dist => dist.IepYearId, opt => opt.MapFrom(c => c.Iep == null ? 0 : c.Iep.AcadmicYear == null ? 0 : c.Iep.AcadmicYear.Id))
          .ForMember(dist => dist.IepTermId, opt => opt.MapFrom(c => c.Iep == null ? 0 : c.Iep.Term == null ? 0 : c.Iep.Term.Id))
          .ReverseMap()
